  ...
  public long hamming(int n) {
    ...
    while (true) {
      ...
      if (--n == 0) {
        ...
        return curr.getValue().longValue();
      }
...
class HammingTriple implements Comparable<HammingTriple> {
  ...
  private final double logOf3 = Math.log(3);
  private final double logOf5 = Math.log(5);
